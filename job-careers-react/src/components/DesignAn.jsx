    ...
    render() {
        return (
            <form>
                ...
                <div>
                    <button type="submit" className="btn btn-default"><b><NavLink to="/ApplyButton">Apply</NavLink></b></button>
                <button type="submit" className="btn btn-default"><b>Apply</b></button>
                </div>
